    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', marginTop: '0.25rem' }}>
            {isSignUp 
              ...
              : '👋 Welcome back! Sign in to access your finances'}
          </p>
        </div>

        {/* 1. CLEAR LOG IN / SIGN UP SEGMENTED TABS */}
        <div style={{
          display: 'grid',
        ...
        <form onSubmit={handleEmailAuth}>
          ...
          <div className="form-group">
            <label style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
              <Lock size={14} /> Password {isSignUp && <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>(min 6 chars)</span>}
            </label>
          ...
          >
            {loading ? 'Please wait...' : isSignUp ? 'Create Free Account' : 'Log In to Account'}
            <ArrowRight size={18} />
          </button>
        </form>

        {/* 3. DIVIDER */}
        <div style={{ display: 'flex', alignItems: 'center', margin: '1.35rem 0', color: 'var(--text-muted)' }}>
        ...
        {/* 5. HELPER SWITCHER FOOTER */}
        <div style={{ marginTop: '1.35rem', textAlign: 'center', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
          {isSignUp ? (
            <span>
        ...
        {/* 6. INSTANT DEMO PREVIEW OPTION */}
        <div style={{ marginTop: '1.35rem', paddingTop: '1.15rem', borderTop: '1px solid var(--border-color)', textAlign: 'center' }}>
          <button
            type="button"
          ...
          >
            <ShieldCheck size={15} color="#10b981" /> Explore with Demo Account (Instant Preview)
          </button>
        </div>
      </div>
    </div>
